package tm.true.loss.core.common.result
...
inline fun <T> Result<T>.onError(action: (Throwable)->Unit): Result<T> { if(this is Result.Error) action(throwable); return this }
